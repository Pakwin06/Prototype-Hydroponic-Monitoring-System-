...
const wtempElement = document.getElementById("wtemp");
  ...
  if (user) {
    ...
    chartRef.on("value", (snapshot) => {
      ...
      dbRef
        ...
        .on("child_added", (snapshot) => {
          ...
          var water_temperature = jsonData.water_temperature;
          var ph = jsonData.ph;
          var timestamp = jsonData.timestamp;
          // Plot the values on the charts
          plotValues(chartT, timestamp, temperature);
          plotValues(chartH, timestamp, humidity);
          plotValues(chartWT, timestamp, water_temperature);
    ...
    dbRef
      ...
      .on("child_added", (snapshot) => {
        ...
        wtempElement.innerHTML = water_temperature;
      ...
      dbRef
        ...
        .on("child_added", function (snapshot) {
          if (snapshot.exists()) {
            ...
            content += "<td>" + water_temperature + "</td>";
            content += "<td>" + ph + "</td>";
            content += "</tr>";
          ...
          if (snapshot.exists()) {
            ...
            reversedList.forEach((element) => {
              if (firstTime) {
                ...
                var water_temperature = element.water_temperature;
                var ph = element.ph;
